...
CREATE TABLE IF NOT EXISTS "weekly_schedule" (
	"id_weekly_schedule" INTEGER NOT NULL UNIQUE GENERATED BY DEFAULT AS IDENTITY,
	"monday" SCHEDULE,
	"tuesday" SCHEDULE,
	"wednesday" SCHEDULE,
	"thursday" SCHEDULE,
...
ALTER TABLE "cce_cards" ADD FOREIGN KEY("id_client") REFERENCES "clients"("id_client") ON UPDATE NO ACTION ON DELETE NO ACTION;
...
CREATE TABLE IF NOT EXISTS "cce_bonus_tiers" (
	"id_tier" INTEGER NOT NULL UNIQUE GENERATED BY DEFAULT AS IDENTITY,
